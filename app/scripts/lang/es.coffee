angular.module 'xmlFiestaUiApp'
  .constant 'TRANSLATIONS_ES', {
    ...
    VERIFY:
      ...
      WHY: '¿Por qué?'
      WRONG_HASH: 'El Hash original es incorrecto.'
      SIGNER: 'Firmante'
      ID: 'RFC'
      ...
      SIGNATURE: 'Firma '
      WRONG_CERT: 'El certificado no fue firmado con ninguno de los certificados raíz que cargaste en la página de configuración. Por favor proporciona nuevos certificados raíz. Si este error persiste significa que el certificado no fue emitido por la autoridad certificadora dueña de los certificados raíz.'
      WRONG_SIG: 'La Firma no es válida, pudo haber sido modificada o no se usó la llave privada correspondiente.'
    ...
    FAQ:
      ...
      HOW: '¿Cómo Funciona?'
      FIRST: '1. Cargar los certificados raíz de la autoridad certificadora (SAT) que emitió los certificados con los que se firmó el documento.'
